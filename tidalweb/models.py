...
class People(models.Model):
    ...
    status = models.CharField(max_length = 255, choices = [('Director', 'Director'), ('Faculty', 'Faculty'), ('Postdoc', 'Postdoc'), ('PhD Student', 'PhD Student'), ('Masters Student', 'Masters Student'), ('Undergraduate', 'Undergraduate Student'), ('Graphic Designer', 'Graphic Designer')])
